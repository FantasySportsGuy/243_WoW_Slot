...
spin<-function(slot){
  reel_1<-sample(x=slot[,1],size=3,replace=FALSE)
  reel_2<-sample(x=slot[,2],size=3,replace=FALSE)
  reel_3<-sample(x=slot[,3],size=3,replace=FALSE)
  reel_4<-sample(x=slot[,4],size=3,replace=FALSE)
  reel_5<-sample(x=slot[,5],size=3,replace=FALSE)
